                                         ...
                                         tDot11fBeaconIEs *pIes, tANI_BOOLEAN fForce)
{
    ...
    do
    {
        ...
        // set the indicator of the channel where the country IE was found...
        pMac->scan.channelOf11dInfo = pSirBssDesc->channelId;
        csrGetRegulatoryDomainForCountry(pMac, pIesLocal->Country.country, &domainId, 0);
                                           ...
                                           tSirBssDescription *pSirBssDesc2, tDot11fBeaconIEs *pIes2, tANI_BOOLEAN fForced )
{
    ...
    {
        if (pCap1->ess && 
                csrIsMacAddressEqual( pMac, (tCsrBssid *)pSirBssDesc1->bssId, (tCsrBssid *)pSirBssDesc2->bssId))//[HTC]remove (pSirBssDesc1->channelId == pSirBssDesc2->channelId) for media link configure fail issue
        {
            fMatch = TRUE;
